...
import { 
  ...
  TextField, Button, Box, Typography, Avatar, Chip, Divider, IconButton
} from '@mui/material';
...
const TaskDetail = ({ open, onClose, task = {} }) => {
  // Đã loại bỏ các biến và hàm không sử dụng: editedTask, setEditedTask, comment, setComment, handleChange, handleAddComment
